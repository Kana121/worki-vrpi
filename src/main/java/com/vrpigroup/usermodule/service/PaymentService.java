...
public class PaymentService {
    ...
    public String createPaymentLink(
        ...
        try {
            ...
            if (coursePrice > 0) {
                JSONObject paymentLinkRequest = createPaymentLinkRequest(Math.toIntExact(coursePrice), firstName, lastName,
                        mobile, email, orderId, userId, courseId, paymentLinkId, paymentLinkUrl);
    ...
    private JSONObject createPaymentLinkRequest(int coursePrice, String firstName, String lastName,
                                                String mobile, String email, Long orderId, Long userId, Long courseId,
